 ...
 */
public class SVCustomWindow_ID extends CaptureWindow {

    private final static String TAG = SVCustomWindow_ID.class.getSimpleName();
    ...
    private SVCustomView_ID _view = null;
     ...
     */
    public SVCustomWindow_ID(Context context, String pref, Map<String, Object> appParams) {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if (_overlayMode == OverlayMode.Replace) {
            ...
            _view = new SVCustomView_ID(this);
        ...
        RelativeLayout view = (RelativeLayout) getView();
        view.addView(new SVPositioningView_ID(this.getActivity()));
