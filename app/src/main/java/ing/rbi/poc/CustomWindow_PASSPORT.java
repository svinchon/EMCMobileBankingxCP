 ...
 */
public class CustomWindow_PASSPORT extends CaptureWindow {

    private final static String TAG = CustomWindow_PASSPORT.class.getSimpleName();
    ...
    private CustomView_PASSPORT _view = null;
     ...
     */
    public CustomWindow_PASSPORT(Context context, String pref, Map<String, Object> appParams) {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        if (_overlayMode == OverlayMode.Replace) {
            ...
            _view = new CustomView_PASSPORT(this);
        ...
        RelativeLayout view = (RelativeLayout) getView();
        view.addView(new PositioningView_PASSPORT(this.getActivity()));
