 ...
 */
class SVCustomView_ID extends RelativeLayout {

    private SVCustomWindow_ID _capWnd = null;
     ...
     */
    SVCustomView_ID(Context context) {
        super(context);
    }
     ...
     */
    SVCustomView_ID(SVCustomWindow_ID capWnd) {
    ...
    private void addButtons() {
        ...
        LayoutParams captureLayoutParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        if (rotation == 1) {
            // PORTRAIT
